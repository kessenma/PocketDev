...
import type { CodexWizardStep, CodexWizardStepStatus } from '@pocketdev/shared/types'

const VISIBLE_STEPS: { key: CodexWizardStep; label: string }[] = [
