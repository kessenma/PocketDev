...
import type { ClaudeWizardStep, ClaudeWizardStepStatus } from '@pocketdev/shared/types'

const VISIBLE_STEPS: { key: ClaudeWizardStep; label: string }[] = [
