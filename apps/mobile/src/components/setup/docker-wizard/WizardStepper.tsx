...
import type { DockerWizardStep, DockerWizardStepStatus } from '@pocketdev/shared/types'

const VISIBLE_STEPS: { key: DockerWizardStep; label: string }[] = [
  { key: 'install', label: 'Install' },
  { key: 'start-daemon', label: 'Daemon' },
  { key: 'add-user-group', label: 'Group' },
