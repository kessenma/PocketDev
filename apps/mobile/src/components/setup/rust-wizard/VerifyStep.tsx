...
const DIAG_CMD = 'echo "--- rustc --version ---" && rustc --version 2>&1; echo "--- cargo --version ---" && cargo --version 2>&1; echo "--- rustup --version ---" && rustup --version 2>&1; echo "--- which rustc ---" && which rustc 2>&1; echo "--- echo $PATH ---" && echo $PATH'
  ...
  return (
    <View style={styles.container}>
      <View style={styles.center}>
        ...
        {state === 'loading' && (
          <SetupProgressCard tone="running" message="Checking rustc and cargo..." />
        )}
        {state === 'success' && (
          <SetupProgressCard tone="success" message="Rust toolchain is installed and working." />
        )}
        {state === 'failed' && (
