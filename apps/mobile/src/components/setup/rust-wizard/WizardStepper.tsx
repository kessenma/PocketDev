...
import type { RustWizardStep, RustWizardStepStatus } from '@pocketdev/shared/types'

const VISIBLE_STEPS: { key: RustWizardStep; label: string }[] = [
  { key: 'install-rustup', label: 'Install' },
