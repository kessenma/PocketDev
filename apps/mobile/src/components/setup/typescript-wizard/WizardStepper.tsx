...
import type { TypeScriptWizardStep, TypeScriptWizardStepStatus } from '@pocketdev/shared/types'

const VISIBLE_STEPS: { key: TypeScriptWizardStep; label: string }[] = [
...
function StepCircle({
  ...
  status: TypeScriptWizardStepStatus
  isActive: boolean
