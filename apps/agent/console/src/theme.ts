...
export function applyConsoleTheme() {
  ...
  root.style.setProperty('--card', darkTheme.surface)
  root.style.setProperty('--card-foreground', darkTheme.text)
  root.style.setProperty('--popover', darkTheme.surface)
  ...
  root.style.setProperty('--secondary', darkTheme.backgroundSecondary)
  ...
  root.style.setProperty('--border', `${darkTheme.border}80`)
  root.style.setProperty('--input', `${darkTheme.borderStrong}66`)
