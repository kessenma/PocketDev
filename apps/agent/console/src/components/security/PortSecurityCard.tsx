...
export function PortSecurityCard() {
  ...
  return (
    <div className="rounded-[1.1rem] border-2 border-[var(--border)] bg-[#1a1713] p-5 text-[#f5eedf] shadow-[0_18px_42px_rgba(0,0,0,0.28)]">
      <div className="flex items-center gap-2">
        <div className="flex h-9 w-9 items-center justify-center rounded-lg border-2 border-black/75 bg-[#2a241d] text-[#f0c419] shadow-[4px_4px_0_0_rgba(0,0,0,0.28)]">
      ...
      {lockStatus ? (
        <div className="mt-4 space-y-3">
          ...
          <div className="grid grid-cols-3 gap-2 text-xs text-[#f4f0e8]/55">
            <div className="rounded-[1rem] border border-white/8 bg-[#12100d] p-2">
