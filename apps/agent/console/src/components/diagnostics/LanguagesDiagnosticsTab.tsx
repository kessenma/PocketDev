...
function CopyableCommand({ command }: { command: string }) {
  ...
  return (
    <div className="flex items-center gap-2">
      <code className="min-w-0 flex-1 break-all rounded-lg border border-border/40 bg-background/40 px-3 py-2 font-mono text-xs text-text-terminal">
        $ {command}
      </code>
      <Button
        variant="ghost"
        size="sm"
        className="h-8 w-8 shrink-0 p-0 text-foreground/50 hover:text-foreground"
        onClick={handleCopy}
      >
  ...
  return (
    <div className="grid h-full gap-3 xl:grid-cols-[minmax(320px,0.78fr)_minmax(0,1.22fr)]">
      ...
      <div className="space-y-3">
        ...
        <div className="rounded-[1.5rem] border border-border/40 bg-background/50 p-4">
          ...
          <div className="mt-4 space-y-3">
            <div className={cn(
              ...
              pythonInfo?.installed ? 'bg-[var(--bauhaus-yellow)] text-black' : 'bg-foreground/6',
            )}>
              <p className={cn('text-[0.68rem] font-semibold uppercase tracking-[0.26em]',
                pythonInfo?.installed ? 'text-black/55' : 'text-foreground/45')}>
                Status
              </p>
              ...
              {pythonInfo?.binary && (
                <p className={cn('mt-1 font-mono text-xs', pythonInfo.installed ? 'text-black/60' : 'text-foreground/50')}>
                  {pythonInfo.binary}
                </p>
              )}
            </div>
            <div className="rounded-[1.2rem] border border-border/40 bg-foreground/6 p-4">
              <p className="text-[0.68rem] font-semibold uppercase tracking-[0.26em] text-foreground/45">pip</p>
            ...
            <div className="rounded-[1.2rem] border border-border/40 bg-foreground/6 p-4">
              <p className="text-[0.68rem] font-semibold uppercase tracking-[0.26em] text-foreground/45">Environment</p>
              <div className="mt-2 space-y-1 text-sm text-foreground/80">
        ...
        {/* Rust status — brand color kept intentionally */}
        <div className="rounded-[1.5rem] border border-border/40 bg-background/50 p-4">
          <div className="flex items-center gap-2">
          ...
          <div className="mt-4 space-y-3">
            <div className={cn(
              'rounded-[1.2rem] border border-border/40 p-4',
              rustInfo?.installed ? 'bg-[#CE422B] text-white' : 'bg-foreground/6',
            )}>
              <p className={cn('text-[0.68rem] font-semibold uppercase tracking-[0.26em]',
                rustInfo?.installed ? 'text-white/65' : 'text-foreground/45')}>
                Status
              </p>
              <p className={cn('mt-2 text-3xl font-semibold',
              ...
              {rustInfo?.path && (
                <p className={cn('mt-1 font-mono text-xs', rustInfo.installed ? 'text-white/60' : 'text-foreground/50')}>
                  {rustInfo.path}
                </p>
              )}
            </div>
            <div className="rounded-[1.2rem] border border-border/40 bg-foreground/6 p-4">
              <p className="text-[0.68rem] font-semibold uppercase tracking-[0.26em] text-foreground/45">Cargo</p>
              <div className="mt-2 space-y-1 text-sm text-foreground/80">
            ...
            <div className="rounded-[1.2rem] border border-border/40 bg-foreground/6 p-4">
              <p className="text-[0.68rem] font-semibold uppercase tracking-[0.26em] text-foreground/45">Rustup</p>
              <div className="mt-2 space-y-1 text-sm text-foreground/80">
        ...
        {/* Go status — brand color kept intentionally */}
        <div className="rounded-[1.5rem] border border-border/40 bg-background/50 p-4">
          <div className="flex items-center gap-2">
          ...
          <div className="mt-4 space-y-3">
            <div className={cn(
              'rounded-[1.2rem] border border-border/40 p-4',
              goInfo?.installed ? 'bg-[#00ADD8] text-white' : 'bg-foreground/6',
            )}>
              <p className={cn('text-[0.68rem] font-semibold uppercase tracking-[0.26em]',
                goInfo?.installed ? 'text-white/65' : 'text-foreground/45')}>
                Status
              </p>
              <p className={cn('mt-2 text-3xl font-semibold',
              ...
              {goInfo?.path && (
                <p className={cn('mt-1 font-mono text-xs', goInfo.installed ? 'text-white/70' : 'text-foreground/50')}>
                  {goInfo.path}
                </p>
              )}
            </div>
        ...
        {/* TypeScript status — brand color kept intentionally */}
        <div className="rounded-[1.5rem] border border-border/40 bg-background/50 p-4">
          <div className="flex items-center gap-2">
          ...
          <div className="mt-4 space-y-3">
            <div className={cn(
              'rounded-[1.2rem] border border-border/40 p-4',
              tsInfo?.installed ? 'bg-[#3178C6] text-white' : 'bg-foreground/6',
            )}>
              <p className={cn('text-[0.68rem] font-semibold uppercase tracking-[0.26em]',
                tsInfo?.installed ? 'text-white/65' : 'text-foreground/45')}>
                Status
              </p>
              <p className={cn('mt-2 text-3xl font-semibold',
              ...
              {tsInfo?.path && (
                <p className={cn('mt-1 font-mono text-xs', tsInfo.installed ? 'text-white/70' : 'text-foreground/50')}>
                  {tsInfo.path}
                </p>
              )}
            </div>
            <div className="rounded-[1.2rem] border border-border/40 bg-foreground/6 p-4">
              <p className="text-[0.68rem] font-semibold uppercase tracking-[0.26em] text-foreground/45">ts-node</p>
              <div className="mt-2 space-y-1 text-sm text-foreground/80">
            ...
            <>
              <div className="rounded-[1.2rem] border border-border/40 bg-background/40 p-4">
                <div className="flex items-start justify-between gap-3">
                  <div className="min-w-0">
                    ...
                    <p className="mt-1 font-mono text-xs text-foreground/50">{pythonInfo.path ?? 'Not found'}</p>
                  </div>
                  <Badge variant="outline" className={cn('border-border/50',
              ...
              <div className="rounded-[1.2rem] border border-border/40 bg-background/40 p-4">
                <div className="flex items-start justify-between gap-3">
                  <div className="min-w-0">
                    ...
                    <p className="mt-1 font-mono text-xs text-foreground/50">{pythonInfo.pip_path ?? 'Not found'}</p>
                  </div>
                  <Badge variant="outline" className={cn('border-border/50',
              ...
              <div className="rounded-[1.2rem] border border-border/40 bg-background/40 p-4">
                <div className="flex items-start justify-between gap-3">
                  ...
                  <Badge variant="outline" className={cn('border-border/50',
                    pythonInfo.ppa_added ? 'text-green-400' : 'text-foreground/40')}>
              ...
              {(!pythonInfo.installed || !pythonInfo.pip_installed || !pythonInfo.venv_available) && (
                <div className="rounded-[1.2rem] border border-border/40 bg-background/40 p-4">
                  <p className="text-[0.68rem] font-semibold uppercase tracking-[0.26em] text-foreground/45">Install Commands</p>
                  <div className="mt-3 space-y-2">
                    {!pythonInfo.installed && (
                      <>
                        <p className="text-xs text-foreground/60">Install Python:</p>
                        <CopyableCommand command="sudo apt update && sudo apt install -y python3" />
                      </>
                    )}
                    {pythonInfo.installed && !pythonInfo.pip_installed && (
                      <>
                        <p className="text-xs text-foreground/60">Install pip:</p>
                    ...
                    {pythonInfo.installed && !pythonInfo.venv_available && (
                      <>
                        <p className="text-xs text-foreground/60">Install venv:</p>
            ...
            <>
              <div className="rounded-[1.2rem] border border-border/40 bg-background/40 p-4">
                <div className="flex items-start justify-between gap-3">
                  <div className="min-w-0">
                    ...
                    <p className="mt-1 font-mono text-xs text-foreground/50">{rustInfo.path ?? 'Not found'}</p>
                  </div>
                  <Badge variant="outline" className={cn('border-border/50',
              ...
              <div className="rounded-[1.2rem] border border-border/40 bg-background/40 p-4">
                <div className="flex items-start justify-between gap-3">
                  <div className="min-w-0">
                    ...
                    <p className="mt-1 font-mono text-xs text-foreground/50">{rustInfo.cargo_path ?? 'Not found'}</p>
                  </div>
                  <Badge variant="outline" className={cn('border-border/50',
              ...
              <div className="rounded-[1.2rem] border border-border/40 bg-background/40 p-4">
                <div className="flex items-start justify-between gap-3">
                  ...
                  <Badge variant="outline" className={cn('border-border/50',
                    rustInfo.rustup_installed ? 'text-green-400' : 'text-foreground/40')}>
              ...
              {!rustInfo.installed && (
                <div className="rounded-[1.2rem] border border-border/40 bg-background/40 p-4">
                  <p className="text-[0.68rem] font-semibold uppercase tracking-[0.26em] text-foreground/45">Install Commands</p>
                  <div className="mt-3 space-y-2">
                    <p className="text-xs text-foreground/60">Install Rust via rustup:</p>
            ...
            <>
              <div className="rounded-[1.2rem] border border-border/40 bg-background/40 p-4">
                <div className="flex items-start justify-between gap-3">
                  <div className="min-w-0">
                    ...
                    <p className="mt-1 font-mono text-xs text-foreground/50">{goInfo.path ?? 'Not found'}</p>
                  </div>
                  <Badge variant="outline" className={cn('border-border/50',
              ...
              <div className="rounded-[1.2rem] border border-border/40 bg-background/40 p-4">
                <div className="flex items-start justify-between gap-3">
                  <div className="min-w-0">
                    ...
                    <p className="mt-1 font-mono text-xs text-foreground/50">{goInfo.gopath ?? 'Not set'}</p>
                  </div>
                </div>
              </div>
              <div className="rounded-[1.2rem] border border-border/40 bg-background/40 p-4">
                <div className="flex items-start justify-between gap-3">
                  <div className="min-w-0">
                    ...
                    <p className="mt-1 font-mono text-xs text-foreground/50">{goInfo.goroot ?? 'Not set'}</p>
                  </div>
                </div>
              </div>
              ...
              {!goInfo.installed && (
                <div className="rounded-[1.2rem] border border-border/40 bg-background/40 p-4">
                  <p className="text-[0.68rem] font-semibold uppercase tracking-[0.26em] text-foreground/45">Install Commands</p>
                  <div className="mt-3 space-y-2">
                    <p className="text-xs text-foreground/60">Install Go:</p>
            ...
            <>
              <div className="rounded-[1.2rem] border border-border/40 bg-background/40 p-4">
                <div className="flex items-start justify-between gap-3">
                  <div className="min-w-0">
                    ...
                    <p className="mt-1 font-mono text-xs text-foreground/50">{tsInfo.path ?? 'Not found'}</p>
                  </div>
                  <Badge variant="outline" className={cn('border-border/50',
              ...
              <div className="rounded-[1.2rem] border border-border/40 bg-background/40 p-4">
                <div className="flex items-start justify-between gap-3">
                  ...
                  <Badge variant="outline" className={cn('border-border/50',
                    tsInfo.ts_node_installed ? 'text-green-400' : 'text-foreground/40')}>
              ...
              {!tsInfo.installed && (
                <div className="rounded-[1.2rem] border border-border/40 bg-background/40 p-4">
                  <p className="text-[0.68rem] font-semibold uppercase tracking-[0.26em] text-foreground/45">Install Commands</p>
                  <div className="mt-3 space-y-2">
                    <p className="text-xs text-foreground/60">Install TypeScript:</p>
